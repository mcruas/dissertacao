...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   Trabalho entregue. \imprimirlocal, 05 de maio de 2014:
...
As séries temporais funcionais foram utilizadas na previsão da ETTJ por \citeonline{hays_functional_2012}, com resultados muito bons. Como é uma abordagem funcional já utilizada na literatura, será implementada para comparação com os resultados obtidos pela estimação com métodos de NP-FDA. \todo{ajeitar referência}
